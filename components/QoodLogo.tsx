...
const BLINK_MIN = 0.18;
const BLINK_SPEED = 0.12;
...
export default function QoodLogo() {
  ...
  return (
    ...
    >
      <defs>
        <mask id="logoMask" maskUnits="userSpaceOnUse">
          ...
          <g fill="white" fillRule="evenodd">
            ...
            {/* O */}
            <path d="M175.25 106C143.938 106 120 83.1875 120 53.1875C120 22.9375 144 0 175.312 0C206.625 0 230.625 22.9375 230.625 53.1875C230.625 83.1875 206.625 106 175.25 106Z" />

            {/* O */}
            <path d="M294.875 106.438C263.562 106.438 239.625 83.625 239.625 53.625C239.625 23.375 263.625 0.4375 294.938 0.4375C326.25 0.4375 350.25 23.375 350.25 53.625C350.25 83.625 326.25 106.438 294.875 106.438Z" />
      ...
      <rect width="100%" height="100%" fill="white" mask="url(#logoMask)" />
    </svg>
  );
}
